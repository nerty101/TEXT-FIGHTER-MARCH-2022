...
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     It's an early conclusion to the contest!\n");
if (diceQ == 2)
printf("     You outfought the opponent at a fast pace!\n");
if (diceQ == 3)
printf("     You settled the contest with efficiency!\n");
if (diceQ == 4)
...
if (((cpusp > 1) && (ctr > 5) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 < 1)) || ((cpusp < 2) && (ctr < 6) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 > 0)) || ((cpusp < 2) && (ctr > 5) && (new6 > 0)) || ((cpusp > 1) && (ctr > 5) && (new6 < 1)))
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
